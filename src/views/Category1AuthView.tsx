...
export const Category1AuthView: React.FC = () => {
  ...
  return (
    <div className="auth-view-container space-y-6 animate-in fade-in duration-300">
      {/* Top Banner Header */}
      <div className="p-6 rounded-3xl bg-[#0a0c10] border border-teal-500/30 shadow-2xl flex flex-wrap items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2 mb-1.5">
            <span className="w-2.5 h-2.5 rounded-full bg-emerald-400 animate-pulse"></span>
            <span className="text-[11px] font-mono text-teal-400 uppercase tracking-widest font-normal">
              1. AUTHENTICATION & SECURITY • تسجيل الدخول والأمان
            </span>
          </div>
          <h1 className="text-2xl font-normal text-white text-white-force drop-shadow-sm flex items-center gap-2">
        ...
        <div className="flex items-center gap-2 bg-[#06080d] p-1.5 rounded-2xl border border-white/10 flex-wrap">
          <button
            onClick={() => setActiveModuleId('auth-secure')}
            className={`px-3 py-2 rounded-xl text-xs font-normal transition-all flex items-center gap-1.5 ${
              activeModuleId === 'auth-secure'
                ? 'bg-[#06080d] text-teal-400 border border-teal-500 shadow-md shadow-teal-500/10'
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center gap-2 border-b border-slate-700/50 pb-2 flex-wrap">
            <button
              ...
              className={`px-4 py-2 rounded-xl text-xs font-normal transition-all flex items-center gap-2 ${
                activeSecureTab === 'login'
                  ? 'bg-[#06080d] text-teal-400 shadow-md border border-teal-500'
          ...
          {activeSecureTab === 'login' && (
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {/* Login Form Panel */}
              <div className="p-6 rounded-3xl bg-[#0a0c10] border border-white/10 shadow-xl space-y-4">
                ...
                <form onSubmit={handleLoginSubmit} className="space-y-4 text-xs">
                  <div>
                    <label className="block text-slate-400 font-normal mb-1">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full bg-[#06080d] border border-white/10 rounded-xl pr-10 pl-3.5 py-2.5 text-white font-normal focus:outline-none focus:border-teal-500"
                        required
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    <label className="block text-teal-400 font-normal mb-1">
                      {t('اختر دور الصلاحية للتوجيه (Role Routing Test)', 'Target Role Privilege to Test')}
                    </label>
                    <select
                      value={selectedRole}
                      onChange={e => setSelectedRole(e.target.value)}
                      className="w-full bg-[#06080d] border border-teal-500/40 rounded-xl px-3.5 py-2.5 text-white font-normal focus:outline-none focus:ring-2 focus:ring-teal-500"
                    >
                  ...
                  <div className="p-3.5 rounded-2xl bg-[#06080d] border border-white/5 space-y-2">
                    <div className="flex items-center justify-between">
                      <span className="text-slate-300 font-normal flex items-center gap-1.5 text-[11px]">
                      ...
                      <button
                        ...
                        className="text-[10px] font-normal text-teal-400 bg-[#06080d] px-3 py-1.5 rounded-lg border border-teal-500 hover:bg-white/5 shadow-sm"
                      >
                    ...
                    {isMfaSent && (
                      <input
                        ...
                        className="w-full bg-[#06080d] border border-teal-500/30 rounded-xl px-3 py-2 text-center text-teal-400 font-mono font-normal tracking-widest text-sm focus:outline-none"
                      />
                    )}
                  </div>
                  ...
                  <button
                    type="submit"
                    className="w-full py-3 rounded-2xl bg-[#06080d] hover:bg-[#0a0c10] text-teal-400 hover:text-emerald-400 font-normal text-xs border-2 border-teal-500 hover:border-emerald-400 shadow-lg shadow-teal-600/20 transition-all flex items-center justify-center gap-2"
                  >
              ...
              <div className="space-y-4">
                <div className="p-6 rounded-3xl bg-[#0a0c10] border border-white/10 shadow-xl space-y-4">
                  <h2 className="text-sm font-normal text-white flex items-center gap-2 pb-3 border-b border-white/10">
                  ...
                  {authResult ? (
                    <div className="space-y-3 animate-in fade-in duration-300">
                      <div className="p-4 rounded-2xl bg-emerald-500/10 border border-emerald-500/30 flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="text-xs font-normal text-emerald-400">{t('تمت المصادقة والتوجيه بنجاح', 'Authentication & Routing Successful')}</p>
                            <p className="text-[10px] text-slate-400">وقت المصادقة: {authResult.timestamp}</p>
                          </div>
                        </div>
                        <span className="px-2.5 py-1 rounded-full bg-teal-500/20 text-white text-[10px] font-mono font-normal">
                          HTTP 200 OK
                        </span>
                      </div>
                      ...
                      <div className="p-4 rounded-2xl bg-[#0a0c10] border border-white/5 space-y-2 text-xs">
                        <div className="flex justify-between py-1 border-b border-white/5">
                          ...
                          <span className="text-white font-normal">{authResult.user}</span>
                        </div>
                        <div className="flex justify-between py-1 border-b border-white/5">
                          <span className="text-slate-400">{t('الصلاحية الممنوحة:', 'Granted Privilege:')}</span>
                          <span className="text-teal-400 font-normal">{authResult.role}</span>
                        </div>
                        <div className="flex justify-between py-1 border-b border-white/5">
                          <span className="text-slate-400">{t('مسار الواجهة المستهدفة:', 'Target Dashboard Route:')}</span>
                          <span className="text-emerald-400 font-mono font-normal">/{authResult.targetRoute}</span>
                        </div>
                        <div className="py-1">
                      ...
                      <button
                        ...
                        className="w-full py-2.5 rounded-xl bg-teal-500/10 hover:bg-teal-600 text-white shadow-md font-normal text-xs border border-teal-500/30 flex items-center justify-center gap-2"
                      >
                    ...
                    <div className="p-8 rounded-2xl bg-[#0a0c10] border border-white/5 text-center text-slate-400 space-y-2">
                      ...
                      <p className="text-xs font-normal">{t('قم بتعبئة النموذج والضغط على "مصادقة وتوجيه" لاختبار التوجيه', 'Fill form and click Authenticate to test role routing')}</p>
                    </div>
                  )}
                </div>
              </div>
            ...
            <div className="p-6 rounded-3xl bg-[#0a0c10] border border-white/10 shadow-xl space-y-4">
              <div className="flex items-center justify-between pb-3 border-b border-white/10">
                ...
                <button
                  ...
                  className="px-3 py-1.5 rounded-xl bg-rose-500/10 hover:bg-rose-500/20 text-rose-400 text-xs font-normal border border-rose-500/20"
                >
                ...
                <table className="w-full text-xs text-start">
                  <thead>
                    <tr className="border-b border-white/10 text-slate-400">
                      <th className="pb-3 text-start font-normal">{t('المستخدم والدور', 'User & Role')}</th>
                      <th className="pb-3 text-start font-normal">{t('الجهاز ونظام التشغيل', 'Device & OS')}</th>
                      <th className="pb-3 text-start font-normal">{t('عنوان IP والموقع', 'IP Address & Location')}</th>
                      <th className="pb-3 text-start font-normal">{t('طريقة المصادقة', 'Auth Method')}</th>
                      <th className="pb-3 text-start font-normal">{t('وقت النشاط', 'Active Time')}</th>
                      <th className="pb-3 text-center font-normal">{t('الإجراء', 'Action')}</th>
                    </tr>
                  </thead>
                      ...
                      <tr key={session.id} className="hover:bg-white/5 transition-colors">
                        <td className="py-3">
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              <p className="font-normal text-white">{session.user}</p>
                              <span className="text-[10px] text-teal-400 font-normal">{session.role}</span>
                            </div>
                          </div>
                        </td>
                        ...
                        <td className="py-3">
                          <span className="px-2 py-0.5 rounded-full bg-[#06080d] text-slate-300 text-[10px] font-normal border border-slate-700">
                            {session.method}
                          </span>
                        </td>
                        ...
                        <td className="py-3 text-center">
                          {session.isCurrent ? (
                            <span className="px-2 py-1 rounded-lg bg-emerald-500/10 text-emerald-400 text-[10px] font-normal border border-emerald-500/20">
                              {t('الجلسة الحالية', 'Current Session')}
                            </span>
                          ) : (
                            <button
                              onClick={() => handleTerminateSession(session.id)}
                              className="px-2.5 py-1 rounded-lg bg-rose-500/10 hover:bg-rose-500/20 text-rose-400 text-[10px] font-normal border border-rose-500/20"
                            >
            ...
            <div className="p-6 rounded-3xl bg-[#0a0c10] border border-white/10 shadow-xl space-y-4">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-xs text-center border-collapse">
                  <thead>
                    <tr className="border-b border-white/10 text-slate-400 bg-[#06080d]">
                  ...
                  <tbody className="divide-y divide-white/5 text-slate-300">
                    <tr>
                      <td className="p-3 text-start font-normal text-white">إدارة الموظفين والملفات</td>
                      <td className="p-3"><span className="px-2 py-0.5 rounded bg-emerald-500/20 text-emerald-400 font-normal">Full Admin</span></td>
                      <td className="p-3"><span className="px-2 py-0.5 rounded bg-emerald-500/20 text-emerald-400 font-normal">Full Admin</span></td>
                      <td className="p-3"><span className="px-2 py-0.5 rounded bg-blue-500/20 text-blue-400 font-normal">Read / Edit</span></td>
                      <td className="p-3"><span className="px-2 py-0.5 rounded bg-slate-800 text-slate-400 font-normal">Dept Only</span></td>
                      <td className="p-3"><span className="px-2 py-0.5 rounded bg-slate-800 text-slate-400 font-normal">Self Only</span></td>
                    </tr>
                    <tr>
                      <td className="p-3 text-start font-normal text-white">حسابات وتجهيز الرواتب</td>
                      <td className="p-3"><span className="px-2 py-0.5 rounded bg-emerald-500/20 text-emerald-400 font-normal">Full Admin</span></td>
                      <td className="p-3"><span className="px-2 py-0.5 rounded bg-emerald-500/20 text-emerald-400 font-normal">Full Admin</span></td>
                      <td className="p-3"><span className="px-2 py-0.5 rounded bg-rose-500/20 text-rose-400 font-normal">No Access</span></td>
                      <td className="p-3"><span className="px-2 py-0.5 rounded bg-slate-800 text-slate-400 font-normal">Approve Only</span></td>
                      <td className="p-3"><span className="px-2 py-0.5 rounded bg-blue-500/20 text-blue-400 font-normal">Payslip View</span></td>
                    </tr>
                    <tr>
                      <td className="p-3 text-start font-normal text-white">موديول الأرشفة المستندية</td>
                      <td className="p-3"><span className="px-2 py-0.5 rounded bg-emerald-500/20 text-emerald-400 font-normal">Full Admin</span></td>
                      <td className="p-3"><span className="px-2 py-0.5 rounded bg-emerald-500/20 text-emerald-400 font-normal">Full Admin</span></td>
                      <td className="p-3"><span className="px-2 py-0.5 rounded bg-blue-500/20 text-blue-400 font-normal">Read Only</span></td>
                      <td className="p-3"><span className="px-2 py-0.5 rounded bg-blue-500/20 text-blue-400 font-normal">Dept Archive</span></td>
                      <td className="p-3"><span className="px-2 py-0.5 rounded bg-slate-800 text-slate-400 font-normal">My Files Only</span></td>
                    </tr>
                    <tr>
                      <td className="p-3 text-start font-normal text-white">إعدادات الأمان والصلاحيات</td>
                      <td className="p-3"><span className="px-2 py-0.5 rounded bg-emerald-500/20 text-emerald-400 font-normal">Full Admin</span></td>
                      <td className="p-3"><span className="px-2 py-0.5 rounded bg-rose-500/20 text-rose-400 font-normal">No Access</span></td>
                      <td className="p-3"><span className="px-2 py-0.5 rounded bg-rose-500/20 text-rose-400 font-normal">No Access</span></td>
                      <td className="p-3"><span className="px-2 py-0.5 rounded bg-rose-500/20 text-rose-400 font-normal">No Access</span></td>
          ...
          {activeSecureTab === 'logs' && (
            <div className="p-6 rounded-3xl bg-[#0a0c10] border border-white/10 shadow-xl space-y-4">
              ...
              <div className="space-y-2">
                {auditLogs.map(log => (
                  <div key={log.id} className="p-3 rounded-2xl bg-[#06080d] border border-white/5 flex items-center justify-between text-xs">
                    <div className="flex items-center gap-3">
                      <span className={`w-2 h-2 rounded-full ${
                        log.status === 'success' ? 'bg-emerald-400' : log.status === 'warning' ? 'bg-amber-400' : 'bg-blue-400'
                      }`}></span>
                      <div>
                        <p className="font-normal text-white">{log.event}</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div
              ...
              className={`p-5 rounded-3xl border cursor-pointer transition-all ${
                ssoProvider === 'azure'
                  ? 'bg-teal-500/20 border-2 border-teal-600 text-slate-900 font-normal shadow-md'
                  : 'bg-[#0a0c10] border-white/10 text-slate-300 hover:border-white/20'
              }`}
            >
              ...
              <h3 className="text-xs font-normal">Microsoft Entra ID / Azure AD</h3>
              <p className="text-[10px] text-slate-400 mt-1">SAML 2.0 / OpenID Connect Sync</p>
              <span className="mt-3 inline-block text-[9px] font-normal text-emerald-400 bg-emerald-500/10 px-2 py-0.5 rounded-full border border-emerald-500/20">
                نشط ومعتمد
              </span>
            </div>
            ...
            >
              ...
              <h3 className="text-xs font-normal">Active Directory (ADFS)</h3>
              <p className="text-[10px] text-slate-400 mt-1">On-Premises Directory Server</p>
              <span className="mt-3 inline-block text-[9px] font-semibold text-black dark:text-teal-300 bg-[#e8ebef] dark:bg-[#06080d] px-2.5 py-0.5 rounded-full border border-slate-300 dark:border-teal-500/30 shadow-sm">
                مربوط محلياً
              </span>
            </div>
            ...
            >
              ...
              <h3 className="text-xs font-normal">Google Workspace</h3>
              <p className="text-[10px] text-slate-400 mt-1">Enterprise OAuth2 SSO</p>
              <span className="mt-3 inline-block text-[9px] font-normal text-slate-400 bg-slate-800 px-2 py-0.5 rounded-full">
                مزود احتياطي
              </span>
            </div>
            ...
            >
              ...
              <h3 className="text-xs font-normal">Okta Identity Cloud</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="p-6 rounded-3xl bg-[#0a0c10] border border-white/10 shadow-xl space-y-4">
              ...
              <div className="space-y-3 text-xs">
                <div>
                  <label className="block text-slate-400 font-normal mb-1">{t('نطاق المؤسسة المعتمد (Corporate Domain)', 'Corporate Domain')}</label>
                  <input
                    type="text"
                    value={ssoDomain}
                    onChange={e => setSsoDomain(e.target.value)}
                    className="w-full bg-[#06080d] border border-white/10 rounded-xl px-3.5 py-2.5 text-teal-400 font-mono font-normal"
                  />
                </div>

                <div>
                  <label className="block text-slate-400 font-normal mb-1">Tenant Directory ID</label>
                  <input
                    type="text"
                    value={tenantId}
                    onChange={e => setTenantId(e.target.value)}
                    className="w-full bg-[#06080d] border border-white/10 rounded-xl px-3.5 py-2.5 text-slate-300 font-mono"
                  />
                </div>

                <div>
                  <label className="block text-slate-400 font-normal mb-1">Application Client ID</label>
                  <input
                    type="text"
                    value={clientId}
                ...
                <div className="p-3 rounded-2xl bg-[#06080d] border border-white/5 flex items-center justify-between">
                  <div>
                    <p className="font-normal text-white text-xs">{t('إنشاء الموظفين الجدد تلقائياً (JIT Auto-Provisioning)', 'Just-In-Time Auto Provisioning')}</p>
                ...
                <div className="flex gap-2 pt-2">
                  <button
                    ...
                    className="flex-1 py-3 rounded-xl bg-[#06080d] text-teal-400 hover:text-white border border-teal-500 hover:bg-white/5 font-normal text-xs shadow-lg shadow-teal-600/10 flex items-center justify-center gap-2 transition-all disabled:opacity-50"
                  >
                ...
                {ssoTestResult && (
                  <div className="p-3 rounded-xl bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 text-xs font-normal flex items-center gap-2">
            ...
            {/* Launch SSO Card */}
            <div className="p-6 rounded-3xl bg-[#0a0c10] border border-white/10 shadow-xl space-y-6 text-center flex flex-col justify-between">
              <div>
                ...
                <h3 className="text-base font-normal text-white">{t('بوابة الدخول الموحد لشركة فيتاس العراق', 'VITAS Iraq Corporate Identity Gateway')}</h3>
              ...
              <div className="p-4 rounded-2xl bg-[#06080d] border border-white/5 text-start text-xs space-y-2 font-mono">
              ...
              <button
                ...
                className="w-full py-3.5 rounded-2xl bg-[#06080d] hover:bg-[#0a0c10] text-teal-400 hover:text-emerald-400 font-normal text-xs border-2 border-teal-500 hover:border-emerald-400 shadow-xl shadow-teal-600/20 flex items-center justify-center gap-2 transition-all"
              >
      ...
      {activeModuleId === 'auth-biometric' && (
        <div className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="p-6 rounded-3xl bg-[#0a0c10] border border-white/10 shadow-xl space-y-6 text-center">
              <div className="flex items-center justify-between pb-3 border-b border-white/10 text-start">
                ...
                <div className="flex bg-[#06080d] p-1 rounded-xl border border-white/10 text-xs">
                  <button
                    onClick={() => setScanType('fingerprint')}
                    className={`px-3 py-1 rounded-lg font-normal transition-all ${scanType === 'fingerprint' ? 'bg-[#06080d] text-teal-400 border border-teal-500' : 'text-slate-400'}`}
                  >
                    بصمة الإصبع
                  </button>
                  <button
                    onClick={() => setScanType('face')}
                    className={`px-3 py-1 rounded-lg font-normal transition-all ${scanType === 'face' ? 'bg-[#06080d] text-teal-400 border border-teal-500' : 'text-slate-400'}`}
                  >
                    التعرف على الوجه
                  </button>
                </div>
              ...
              <div className="relative py-8">
                <div className={`w-36 h-36 mx-auto rounded-full border-4 transition-all flex items-center justify-center relative shadow-lg ${
                  isScanning 
                    ? 'border-teal-400 bg-teal-500/20 shadow-[0_0_50px_rgba(20,184,166,0.6)] animate-pulse' 
                    : scanResult?.success
                      ? 'border-emerald-500 bg-emerald-500/20 shadow-emerald-500/30'
                      : 'border-teal-500/50 bg-teal-50 dark:bg-[#06080d] shadow-teal-500/20'
                }`}>
                  <span className={`material-symbols-outlined text-7xl transition-all ${
                    isScanning 
                ...
                <p className="text-xs font-normal text-slate-300 mt-4">
                  {isScanning 
                ...
                {scanResult?.success && (
                  <div className="mt-3 inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/20 border border-emerald-500/30 text-emerald-400 text-xs font-normal">
              ...
              <button
                ...
                disabled={isScanning}
                className="w-full py-3.5 rounded-2xl bg-[#06080d] hover:bg-[#0a0c10] text-teal-400 hover:text-emerald-400 font-normal text-xs border-2 border-teal-500 hover:border-emerald-400 shadow-xl shadow-teal-600/20 flex items-center justify-center gap-2 transition-all disabled:opacity-50"
              >
                <span className="material-symbols-outlined text-lg">{scanType === 'fingerprint' ? 'touch_app' : 'center_focus_strong'}</span>
                <span className="text-teal-400 font-normal">{isScanning ? t('جاري مسح البصمة الحيوية...', 'Scanning...') : t('بدء المسح البيومتري المباشر', 'Start Biometric Scan Test')}</span>
              </button>
            </div>
            ...
            <div className="p-6 rounded-3xl bg-[#0a0c10] border border-white/10 shadow-xl space-y-4">
              ...
              <div className="space-y-3">
                {terminals.map(term => (
                  <div key={term.id} className="p-4 rounded-2xl bg-[#06080d] border border-white/5 space-y-2">
                    <div className="flex items-center justify-between text-xs">
                      <div className="flex items-center gap-2">
                        <span className={`w-2.5 h-2.5 rounded-full ${term.status === 'online' ? 'bg-emerald-400 animate-pulse' : 'bg-amber-400'}`}></span>
                        <span className="font-normal text-white">{term.name}</span>
                      </div>
                      <span className="text-[10px] font-mono font-semibold text-black dark:text-teal-300 bg-[#e8ebef] dark:bg-[#06080d] px-2.5 py-0.5 rounded-full border border-slate-300 dark:border-teal-500/30 shadow-sm">
                        {term.type}
                      </span>
                    </div>
                    ...
                    <div className="flex justify-between items-center text-[11px] text-slate-400">
                      ...
                      <span>الموظفين المسجلين: <strong className="text-emerald-400 font-normal">{term.enrolledCount}</strong></span>
                    </div>
                  </div>
                ))}
              </div>
              ...
              <div className="p-4 rounded-2xl bg-[#06080d] border border-white/5 space-y-3 text-xs">
                <h3 className="font-normal text-white text-xs flex items-center gap-1.5">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <select
                    ...
                    className="bg-[#06080d] border border-white/10 rounded-lg px-2.5 py-1 text-teal-400 font-normal focus:outline-none"
                  >
