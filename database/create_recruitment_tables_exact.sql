-- Create recruitment tables that exactly match the application types
-- Based on JobVacancy and Candidate interfaces in src/types.ts
...
-- Create job_vacancies table - exactly matching JobVacancy interface
...
-- Create candidates table - exactly matching Candidate interface
...
-- Insert sample job vacancies matching the positions from settings
...
-- The script completed successfully. Use check_recruitment_data.js to verify the data.
